...
LWP::UserAgent - Mock LWP::UserAgent class
...
This Perl class mocks whatever portion of the
L<LWP::UserAgent|LWP::UserAgent> interface is needed by
...
the real L<LWP::UserAgent|LWP::UserAgent>.
...
The return is generated by C<< HTTP::Response->new( $status ) >>.

=head1 SEE ALSO

L<LWP::UserAgent|LWP::UserAgent> (the real one).
