...
my @optionals = (
    __any( 'CPANPLUS'			=> <<'EOD' ),
      This module is needed if you intend to use the CPANPLUS module
      index to validate links to uninstalled modules.
EOD
    __any( qw{ HTTP::Tiny LWP::UserAgent }	=> <<'EOD' ),
      One of these modules is needed if you intend to check URL links OR
      you intend to use the CPAN Meta Database to validate links to
      uninstalled modules.
EOD
);
